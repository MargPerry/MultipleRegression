...
```
```{r}
nullmodel <- lm(logkq5_cond_parq1~1, data = newData)
fullmodel <- lm(logkq5_cond_parq1~tier + hbcu + black_share_fall_2000 + alien_share_fall_2000 + pct_stem_2000 + par_median + endowment_pc_2000 + count, data = newData)
...
```
```{r}
summary(lm(logkq5_cond_parq1~tier + black_share_fall_2000 + alien_share_fall_2000 + pct_stem_2000 + par_median + endowment_pc_2000, data = newData))
```
